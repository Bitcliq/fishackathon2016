<%@ Page Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="PropertiesPage.aspx.cs" Inherits="Bitcliq.BIR.Portal.PropertiesPage" %>
...
<asp:Content ContentPlaceHolderID="masterCp" runat="server">
  ...
  <link rel='stylesheet' type='text/css' href='assets/plugins/datatables/dataTables.css?v=1' />
    ...
    <script>
        var handlerUrl = 'PropertiesHandler.ashx';
        var editor;
        $(function () {
            // edit inline
